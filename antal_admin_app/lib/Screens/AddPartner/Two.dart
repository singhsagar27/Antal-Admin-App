...
class AddPartnerScreenTwo extends StatefulWidget {
  AddPartnerScreenTwo({
    Key key,
  }) : super(key: key);
...
class _RegisterCompanyState extends State<AddPartnerScreenTwo> {
