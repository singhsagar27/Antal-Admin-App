...
class AddPositionScreenTwo extends StatefulWidget {
  ...
  @override
  _RegisterCompanyState createState() => _RegisterCompanyState(positionID);
}

class _RegisterCompanyState extends State<AddPositionScreenTwo> {
  String positionID='';
  _RegisterCompanyState(this.positionID);
    ...
    return MaterialButton(
      ...
      onPressed: () async {
        if (_fbKey.currentState.saveAndValidate()) {
          ...
          // );
          // final result = await PositionService.position_api(note);
          // print(result.data);
