class PositionModel {
  ...
  var client_name, department_name, position_name, years_of_exp, salary_offered, accepted_educational_qualification, target_industry, position_type, position_level, 
  ...
  PositionModel({this.client_name, this.department_name, this.position_name, this.years_of_exp, this.salary_offered, this.accepted_educational_qualification, this.target_industry, 
