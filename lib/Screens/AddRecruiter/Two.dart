...
class AddRecruiterScreenTwo extends StatefulWidget {
  AddRecruiterScreenTwo({
    Key key,
  }) : super(key: key);
...
class _RegisterCompanyState extends State<AddRecruiterScreenTwo> {
